...
module.exports = {
  ...
  is: require('./is/index.js').default,
  ...
  juxt: require('./juxt/index.js').default,
  ...
  partition: require('./partition/index.js').default,
  prepend: require('./prepend/index.js').default,
  range: require('./range/index.js').default,
  reject: require('./reject/index.js').default,
